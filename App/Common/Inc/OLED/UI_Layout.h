...
// 메인 영역 분할
#define LEFT_AREA_WIDTH     96   // 좌측 배터리 영역
...
#define BATTERY_AREA_WIDTH  96
#define BATTERY_AREA_HEIGHT 64

// 배터리 원형 프로그래스 (좌측 영역 중앙)
#define BATTERY_CENTER_X    40   // 96/2 = 48
...
// 1구역: 타이머 시간 (분:초)
#define INFO_TIMER_X        103   // 96 + 2 (여백)
#define INFO_TIMER_Y        2    // 첫 번째 구역
#define INFO_TIMER_WIDTH    28
#define INFO_TIMER_HEIGHT   12

// 2-3구역: 상태 아이콘 (32픽셀 높이로 큰 아이콘)
#define INFO_STATUS_X       100  // 중앙 정렬
#define INFO_STATUS_Y       18   // 두 번째 구역 시작
#define INFO_STATUS_WIDTH   16   // 16x16 아이콘
#define INFO_STATUS_HEIGHT  32   // 2구역 합친 높이

// 4구역: L1, L2 연결 상태 (원형)
#define INFO_L1_X           105  // 중앙에서 좌측
#define INFO_L1_Y           56   // 네 번째 구역
#define INFO_L1_RADIUS      5    // 원형 반지름

#define INFO_L2_X           120  // 중앙에서 우측
#define INFO_L2_Y           56   // 네 번째 구역
